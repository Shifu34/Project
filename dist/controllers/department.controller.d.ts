...
export declare const getDepartmentLocations: (_req: Request, res: Response, next: NextFunction) => Promise<void>;
export declare const getDepartments: (_req: Request, res: Response, next: NextFunction) => Promise<void>;
export declare const getDepartmentById: (req: Request, res: Response, next: NextFunction) => Promise<void>;
